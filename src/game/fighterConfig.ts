...
import { SAKURA_FIGHTER_CHARACTER_ID } from './sakuraFighter';
import type {
  AttackKind,
  AttackProfile,
...
const FIGHTER_STAT_OVERRIDES: Record<string, Partial<FighterStats>> = {
  ...
  [SAKURA_FIGHTER_CHARACTER_ID]: { walkSpeed: 255, airDrift: 220, jump: 1020, scale: 1.35 }
};
